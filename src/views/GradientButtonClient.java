...
public class GradientButtonClient extends JButton implements ActionListener{
	private static final long serialVersionUID = 1L;
	private JDmainMenuClient jDmainMenu;
	private int clicks;
	private Point2D location;
	public GradientButtonClient(Point2D point2d,ActionListener listener) {
		clicks = 1;
	 	this.addActionListener(this);
	 	location = point2d;
	 	jDmainMenu = new JDmainMenuClient((int)point2d.getX()+500, (int)point2d.getY()+500,
	 			listener);
